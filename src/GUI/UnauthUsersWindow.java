...
public class UnauthUsersWindow extends JFrame {

    private JTable table;

    public UnauthUsersWindow(User user) {
        ...
        JLabel lbTitle = new JLabel("Unauthorized users");
    ...
    private void initMainPanel(User user) {
        ...
        JButton btnAuthUser = new JButton("Authorize user");
        btnAuthUser.addActionListener(arg0 -> {
            if (table.getSelectedRow() == -1) {
                ...
                dal.authorizeUser(userId);
                mainPanel.removeAll();
                initMainPanel(user);
            }
        });
        btnAuthUser.setBounds(10, 11, 130, 23);
        btnAuthUser.setForeground(Color.BLACK);
        btnAuthUser.setBackground(Color.GRAY);
        mainPanel.add(btnAuthUser);
        ...
        btnDeleteAccount.setBounds(160, 11, 130, 23);
        ...
        DataAccessLayer dal = new DataAccessLayer();
        Vector<User> accounts = dal.getAccounts("Unauthorized");
